...
// Usage: /api/live-scores?leagueId=39&date=2026-06-28&season=2025

// Map your app's league IDs to API-Football's league IDs + season year.
// Season is the year the season STARTS in (e.g. 2025/26 season = 2025).
const LEAGUE_MAP = {
...
// Map API-Football's short status codes to simple states our app understands.
function mapStatus(shortStatus) {
  ...
  return "upcoming"; // NS (not started), TBD, PST, etc.
}
